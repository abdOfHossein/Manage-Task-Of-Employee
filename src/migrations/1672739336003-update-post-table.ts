...
export class updatePostTable1672739336003 implements MigrationInterface {
    name = 'updatePostTable1672739336003'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "task" ALTER COLUMN "do_date" SET DEFAULT '"2023-01-03T09:49:04.036Z"'`);
