...
export class updatePostTable1672810904164 implements MigrationInterface {
    name = 'updatePostTable1672810904164'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "task" ALTER COLUMN "do_date" SET DEFAULT '"2023-01-04T05:42:00.172Z"'`);
