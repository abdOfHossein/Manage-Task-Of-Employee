...
export class updatePostTable1674297673462 implements MigrationInterface {
    name = 'updatePostTable1674297673462'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "file" ("create_at" TIMESTAMP NOT NULL DEFAULT now(), "update_at" TIMESTAMP NOT NULL DEFAULT now(), "delete_at" TIMESTAMP, "id" uuid NOT NULL DEFAULT uuid_generate_v4(), "mime_type" character varying NOT NULL, "unq_file" character varying NOT NULL, "size" integer NOT NULL, "file" character varying NOT NULL, "file_path" character varying NOT NULL, "original" character varying, "type_file" "public"."file_type_file_enum" NOT NULL, "status" "public"."file_status_enum" NOT NULL DEFAULT 'SUSPEND', "userId" uuid, CONSTRAINT "UQ_4db1023038b64b108676dbc6ed8" UNIQUE ("unq_file"), CONSTRAINT "PK_36b46d232307066b3a2c9ea3a1d" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "task" ("create_at" TIMESTAMP NOT NULL DEFAULT now(), "update_at" TIMESTAMP NOT NULL DEFAULT now(), "delete_at" TIMESTAMP, "id" uuid NOT NULL DEFAULT uuid_generate_v4(), "priority" character varying, "title" character varying, "head_id" character varying, "do_date" TIMESTAMP DEFAULT '"2023-01-21T10:41:55.934Z"', "remain_date" TIMESTAMP, "type" "public"."task_type_enum", "duration" integer, "status" "public"."task_status_enum", "check_status" "public"."task_check_status_enum", "departmentRlId" uuid, "userId" uuid, CONSTRAINT "PK_fb213f79ee45060ba925ecd576e" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "event" ("create_at" TIMESTAMP NOT NULL DEFAULT now(), "update_at" TIMESTAMP NOT NULL DEFAULT now(), "delete_at" TIMESTAMP, "id" uuid NOT NULL DEFAULT uuid_generate_v4(), "priority" character varying, "start_date" TIMESTAMP, "end_date" TIMESTAMP, "title" character varying, CONSTRAINT "PK_30c2f3bbaf6d34a55f8ae6e4614" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "file_manager" ("create_at" TIMESTAMP NOT NULL DEFAULT now(), "update_at" TIMESTAMP NOT NULL DEFAULT now(), "delete_at" TIMESTAMP, "id" uuid NOT NULL DEFAULT uuid_generate_v4(), "title" character varying NOT NULL, "destination_id" character varying NOT NULL, "description" character varying NOT NULL, "files" text array NOT NULL, "reciverType" "public"."file_manager_recivertype_enum" NOT NULL DEFAULT 'PUBLIC', CONSTRAINT "PK_737201044e826a80ade8f858d81" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`ALTER TABLE "task"."rel_task" ADD CONSTRAINT "FK_46f8e19c5d5b9f33da18d1bb2d7" FOREIGN KEY ("srcId") REFERENCES "task"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "task"."rel_task" ADD CONSTRAINT "FK_d328bf1d77cb9e8da237ce1f1ea" FOREIGN KEY ("refId") REFERENCES "task"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE "task" ADD CONSTRAINT "FK_eebd5d2a074ee6cdde920afb1b2" FOREIGN KEY ("departmentRlId") REFERENCES "task"."DepartmentRl"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "task" ADD CONSTRAINT "FK_f316d3fe53497d4d8a2957db8b9" FOREIGN KEY ("userId") REFERENCES "auth"."user"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
